        ...
        <div className="space-y-2">
            ...
            {!readOnly && (
                <div className="flex gap-2">
                    <input
                        type="text"
                        className="flex-1 rounded-lg border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 text-sm p-2 border"
            ...
            {helperText && !readOnly && <p className="text-xs text-gray-500">{helperText}</p>}
            ...
            <div className="flex flex-wrap gap-2 min-h-[2rem]">
                ...
                )) : <span className="text-gray-400 text-xs italic p-1">Nenhum item adicionado.</span>}
            </div>
        </div>
    );
};
