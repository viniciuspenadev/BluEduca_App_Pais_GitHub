...
export default function CommunicationDetailPage() {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined' && window.visualViewport) {
            const handleResize = () => {
                ...
                if (height) setViewportHeight(`${height}px`);
                // Removido window.scrollTo(0, 0) que causava o pulo na lista de fundo
            };
    ...
    return (
        <motion.div
            ...
            className="fixed inset-0 bg-gray-50 flex flex-col overflow-hidden z-[60] selection:bg-blue-100"
        ...
        >
            ...
            {/* Content Area */}
            <main className="flex-1 overflow-y-auto scroll-smooth overscroll-contain px-4 py-6 space-y-8">
            ...
            {/* Input Floating Bar */}
            <div className="absolute bottom-0 left-0 right-0 p-4 pb-safe-area pointer-events-none">
                <div className="max-w-2xl mx-auto flex flex-col pointer-events-auto">
                    ...
                    <div className="bg-white/95 backdrop-blur-2xl rounded-[32px] p-2 pr-2.5 pl-3 border border-white/50 shadow-[0_10px_40px_rgba(0,0,0,0.12)] flex items-end gap-2 group focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                        ...
                        <div className="flex-1 min-h-[48px] flex items-center py-2">
                            <textarea
                                ...
                                className="w-full bg-transparent border-none focus:ring-0 resize-none max-h-32 text-sm text-gray-800 placeholder-gray-400 font-bold py-1 px-1"
                                rows={1}
                            />
                        </div>
